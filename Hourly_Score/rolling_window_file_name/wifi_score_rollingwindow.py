...
sys.path.append('/usr/apps/vmas/script/ZS/HourlyScore/Rolling_window_score') 
from StationConnection_rollingWindow import  LogTime, StationHistoryReader, StationConnectionProcessor
...
if __name__ == "__main__":
    ...
    station_connection_path = f"{hdfs_pa}/sha_data/hourlyScore_rollingWindow/station_connection_rollingWindow"
    wifi_score_output_path = f"{hdfs_pa}/sha_data/hourlyScore_rollingWindow/wifi_score_rollingWindow"
    # --------------------------------------------------------
    # HDFS StationHistoryReader
    # --------------------------------------------------------
    ...
    date_str = reader.get_latest_date()
    hour_str = reader.get_latest_hour(date_str)
    ...
    # --------------------------------------------------------
        ...
        if hour_str == '00':
            ...
            with LogTime() as timer:
                ...
                station_connection_df = processor.compute_stationarity()
