...
/usr/apps/vmas/spark/bin/spark-submit \
  ...
  /usr/apps/vmas/script/ZS/HourlyScore/Rolling_window_score/StationConnection_rollingWindow.py \
  > /usr/apps/vmas/script/ZS/HourlyScore/Rolling_window_score/StationConnection_rollingWindow.log
