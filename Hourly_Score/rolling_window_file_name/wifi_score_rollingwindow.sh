...
/usr/apps/vmas/spark/bin/spark-submit \
  ...
  /usr/apps/vmas/script/ZS/HourlyScore/Rolling_window_score/wifi_score_rollingwindow.py \
  > /usr/apps/vmas/script/ZS/HourlyScore/Rolling_window_score/wifi_score_rollingwindow.log
